...
async function insertBatch({ prisma, ref, sku, qty, eta }): Promise<number> {
...
async function insertOrderLine({ prisma, orderRef, sku, qty }): Promise<number> {
  await prisma.$queryRaw`
...
async function insertAllocation({ prisma, batchId, orderlineId }): Promise<void> {
  await prisma.$queryRaw`
